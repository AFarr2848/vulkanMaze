...
static vk::VertexInputBindingDescription Vertex::getBindingDescription() {
  return {0, sizeof(Vertex), vk::VertexInputRate::eVertex};
}
static std::array<vk::VertexInputAttributeDescription, 1> getAttributeDescriptions() {
  return {
      //////////IM WORKING ON THIS IM DOING A CUBE DONT FORGET I DIDN"T CHANGE THIS YET I DID THE SHADer tho "
...
private:
  ...
  void drawFrame() {
    ...
    std::cout << "Mat uniform: " << materialUBOMemory;
